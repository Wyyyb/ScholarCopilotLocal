...
def sc_generate(model_info, text):
    ...
    current_text, cite_start_hidden_state = single_generate_full(model, tokenizer, device, current_text, 0)
    reference_id_list = []
...
def eval_sc_generate():
    output_path = "../data/eval_generation_result_unlimit_0228.json"
    # output_path = "../data/eval_generation_result_0226_12k.json"
    model_info = load_sc_model(device="6")
